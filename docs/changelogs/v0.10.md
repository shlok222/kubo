...
- github.com/ipld/go-ipld-prime (v0.9.1-0.20210324083106-dc342a9917db -> v0.12.2):
  ...
  - mark v0.11.0
  - node/bindnode: mark as experimental in its go doc.
  ...
  - Sort map entries marshaling dag-cbor
...
- github.com/libp2p/go-libp2p-pubsub (v0.4.2 -> v0.5.4):
  ...
  - emit new peer notifications without holding the semaphore
